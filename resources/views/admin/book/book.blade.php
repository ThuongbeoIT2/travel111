            ...
            <div id="datatable_wrapper" class="dataTables_wrapper no-footer">
                ...
                <table id="datatable"
                    ...
                    <tr role="row">
                        ...
                        <th class="" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Country: activate to sort column ascending">SDT
                        </th>
                        <th class="" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Country: activate to sort column ascending">Thời gian đặt tour
                        </th>
                        <th class="" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1"
                            aria-label="Status: activate to sort column ascending" style="width: 70%">Tour
                        </th>
