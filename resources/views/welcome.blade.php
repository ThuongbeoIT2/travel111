                                            ...
                                            <div class="col-md-6">
                                                <div class="hero-text">
                                                    ...
                                                    <div class="banner-button-group">
                                                        <a href="{{Request::root().'/contact'}}" class="btn btn-primary animate__animated animate__fadeInUp">
                                                            Contact Us
                                                        </a>
                                                        <a href="{{Request::root().'/tour'}}" class="btn btn-primary learn-more animate__animated animate__fadeInUp">
                                                            Learn More
                                                        </a>
                                                    </div>
                                                </div>
